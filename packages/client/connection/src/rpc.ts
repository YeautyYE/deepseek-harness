...
export interface HostConnectionRpc {
   ...
   * Consumers inject only Connection. The channel follows WebServer availability
   * and its caller's lifetime; disposal waits for its physical route to be removed.
