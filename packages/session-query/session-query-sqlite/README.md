...
| `preparedSessionCacheMaxBytes` | `33554432` | Estimated decoded header and event bytes retained across inherited cold observations; `0` disables released-entry retention |
